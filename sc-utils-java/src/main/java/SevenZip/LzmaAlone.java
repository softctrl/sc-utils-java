...
public class LzmaAlone {
	...
	public static void main(String[] args) throws Exception {
		...
		String input = "/home/timoshenko/git/sc-utils-java/sc-utils-java/src/main/java/SevenZip/LzmaAlone.java";
		String output = "/home/timoshenko/git/sc-utils-java/sc-utils-java/src/main/java/SevenZip/LzmaAlone.out";

		String[] params2 = new String[] { "e", input, output };
