...
public final class Objects {
	...
	public static final class StringHelper {
		...
		private StringHelper(final Class<?> clazz) {
			this.mDescription.append(String.format(Constants.CLASS_FORMAT, Objects.requireNonNull(clazz).getSimpleName()));
		}
	 ...
	 * @return
	 */
	public static boolean nonNullOrEmpty(boolean[] tArray) {
		return (tArray != null && tArray.length > 0);
	}
	...
	public static boolean and(boolean... values) {
		boolean result = nonNullOrEmpty(values);
		if (result) {
